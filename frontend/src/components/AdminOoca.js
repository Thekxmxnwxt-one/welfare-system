...
const API_URL = '/api/v1/ooca-check'; // URL สำหรับดึงข้อมูลการเคลม

const AdminOocaCheck = () => {
        ...
        <div className="admin-claims-management">
            ...
            {selectedClaim && (
                <div className="claim-detail">
                    ...
                    <p><strong>วันที่ขอเข้าตรวจ:</strong> {selectedClaim.request_date}</p>
                    <p><strong>เหตุผล:</strong> {selectedClaim.reason}</p>
