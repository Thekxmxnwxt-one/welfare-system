...
const RequestOocaCheck = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const requestBody = {
            person_id: user.id,
            request_date: formData.request_date + 'T00:00:00Z',
            reason: formData.reason, // กำหนดเวลา
            status: 'รอการพิจารณา'
        };
        ...
        try {
            const response = await fetch('/api/v1/ooca-check', {
                method: 'POST',
                headers: {
...
export default RequestOocaCheck;
